      ...
      {isOpen && (
        <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 sm:p-8 pointer-events-none">
          ...
          <motion.div
            ...
            className="relative w-full max-w-2xl bg-[var(--color-bg)] rounded-[2rem] sm:rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col max-h-full pointer-events-auto border border-[var(--color-border)]"
          >
